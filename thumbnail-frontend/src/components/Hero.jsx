...
>
  ...
  <span className="text-xs text-gray-200/90">
    Trusted by creators to generate high-click AI thumbnails
  </span>
</motion.a>
                            ...
                            >
                               We help creators and brands grow faster with AI-generated thumbnails designed to attract clicks, boost engagement, and increase visibility across platforms..
                            </motion.p>
...
>
  ...
  <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
    ...
    <div>
      <div>Instant & scalable</div>
      <div className="text-xs text-gray-400">
        Create unlimited thumbnails fast
      </div>
    </div>
  </div>
</motion.div>
                      ...
                      {/* Right: AI thumbnail preview card */}
<motion.div
    ...
    <div className="relative aspect-16/10 bg-gray-900">
      ...
      <div className="absolute right-4 bottom-4">
        <button className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-white/6 backdrop-blur-sm hover:bg-white/10 transition focus:outline-none">
          <PlayIcon className="size-4" />
          <span className="text-xs">Preview thumbnail</span>
        </button>
      </div>
    </div>
  </motion.div>
