...
import { plansData } from '../assets/dummy-data'   // ✅ IMPORTED FROM DUMMY DATA
  ...
  return (
    <section id="pricing" className="py-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <Title
          title="Pricing"
          heading="Simple pricing for every creator"
          description="Choose a plan that fits your channel. Upgrade or cancel anytime — no hidden fees."
        />
